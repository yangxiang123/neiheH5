								...
								<label class="uni-list-cell uni-list-cell-pd">
									<view>
										<!-- <checkbox color="#02b300"
												  ...
												  :value="item.user_id + ''"
										/> -->
										<u-checkbox v-model="item.other" @change="change(item.user_id + '')" ></u-checkbox>
									</view>
									<view class="uni-media-list">
										<view class="uni-media-list-logo">
											<image  :data-index="index" :src="item.photo" :lazy-load="true" style="border-radius: 10px;" @error="imageError"  />
										</view>
...
<script>
	...
	import _mixin from "../../common/_mixins";
	import uniSearchBar from '@/components/mehaotian-search/mehaotian-search.vue'
	import checkbox from "@/uview-ui/components/u-checkbox-group/u-checkbox-group.vue"
	export default {
		components: {
			uniIcon,
			uniList,
