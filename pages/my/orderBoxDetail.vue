	...
	<view class="">
		...
		<view class="padding bot_bg">
			<view class="flex align-center margin-top-sm bg-white pad24 radius20">
				<image :src="all.box?all.box.box_image:''" style="width: 160rpx;height: 160rpx;border-radius: 20rpx;" mode="">
				</image>
				<view class="padding-left-sm flex-sub">
					<view class="font30">
						{{all.box?all.box.box_name:''}}
					</view>
			...
			<view v-if="all.order_status == 0" class="foot-box flex align-center justify-between bg-white"
				...
				<view class="btnbggg" style="width: 400rpx;height:88rpx;" @click="paySubmit2">
					确定支付
				</view>
			</view>
		</view>
			...
			inputVal(e) {
				...
				if (e.length == 6) {
					uni.request({
						...
						// url:'https://h5.cbart.com.cn/api/user/check_pay_available',
